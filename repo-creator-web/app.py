...
def create_github_repo(token, org_name, repo_name, team_slugs, labels, add_cloudbuild):
...
def index():
    if request.method == 'POST':
        ...
        try:
            create_github_repo(token, org_name, repo_name, team_slugs, labels, add_cloudbuild)
